    ...
    <v-form class="form-container" ref="form">
      ...
      <div v-else-if="itemType === 'discounts'">
        <div class="fields-container">
          ...
          <Input label="Voucher code" :value="item.voucherCode" placeholder="Enter voucher code"
                 hint="Voucher code used by customers"/>
          <Select label="Type" :items="discountTypes" :rules="required" :value="item.type"/>
          <Input label="Value" :value="item.discountValue" placeholder="Enter a number..."
                 hint="Discount value (rate or amount)"/>
          <Select label="Trigger threshold rules" :items="thresholdRules" :value="item.triggerRule"/>
          <Input label="Threshold" :value="item.triggerValue" placeholder="Enter a number..."
                 hint="Trigger threshold (amount or quantity)"/>
