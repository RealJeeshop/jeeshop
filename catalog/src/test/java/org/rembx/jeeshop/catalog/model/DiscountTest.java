...
public class DiscountTest {
    ...
    public void processAmountDiscountWithRate() throws Exception {
        Discount discount = new Discount("discount1", "a discount", ORDER, DISCOUNT_RATE, AMOUNT, null,10.0, 2.0, 1, true,null,null, false, "test@test.com");
    ...
    public void processAmountDiscountWithDiscountValue() throws Exception {
        Discount discount = new Discount("discount1", "a discount", ORDER, ORDER_DISCOUNT_AMOUNT, AMOUNT, null,5.0, 2.0, 1, true,null,null, false, "test@test.com");
        assertThat(discount.processDiscount(10.0,10.0)).isEqualTo(5);
    }

    @Test
    public void processShippingDiscount() throws Exception {
        Discount discount = new Discount("discount1", "a discount", ORDER, SHIPPING_FEE_DISCOUNT_AMOUNT, AMOUNT, null,5.0, 2.0, 1, true,null,null, false, "test@test.com");
        assertThat(discount.processDiscount(10.0,10.0)).isEqualTo(5);
    }

    @Test
    public void isEligible_givenItemsPriceLowerThanTriggerValueAndAmountTrigger_shouldReturnFalse_() throws Exception{
        Discount discount = new Discount("discount1", "a discount", ORDER, DISCOUNT_RATE, AMOUNT, null, 0.1, 2.0, 1, true,null,null, false, "test@test.com");
    ...
    public void isEligible_WhenDiscountHasNullTriggerValue_shouldReturnTrue_() throws Exception{
        Discount discount = new Discount("discount1", "a discount", ORDER, DISCOUNT_RATE, AMOUNT, null, 0.1, null, 1, true,null,null, false, "test@test.com");
        assertThat(discount.isEligible(2.0)).isTrue();
    }
}